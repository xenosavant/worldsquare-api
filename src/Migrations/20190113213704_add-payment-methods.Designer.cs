...
namespace Stellmart.Api.Migrations
{
    ...
    [Migration("20190113213704_add-payment-methods")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stellmart.Api.Context.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("TwoFactorAuthTime");
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Contract", b =>
                {
                    ...
                    b.Property<int>("FundingAmount");

                    b.Property<int>("FundingAssetId");
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.MessageThreadMember", b =>
                {
                    b.Property<int>("MessageThreadId");
                    ...
                    b.HasKey("MessageThreadId", "UserId");

                    b.HasIndex("ListingId");

                    b.HasIndex("UserId");

                    b.ToTable("MessageThreadMember");
                });

            modelBuilder.Entity("Stellmart.Api.Context.Entities.Obligation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("FundingTimeLimit");

                    b.Property<int>("InteracationId");

                    b.Property<int>("IntermediaryPhases");
                    ...
                    b.Property<DateTime>("ServiceFulfillmentTimeLimit");

                    b.Property<int>("ServiceId");

                    b.Property<DateTime>("ServiceInitiationTimeLimit");

                    b.Property<DateTime>("ServiceReceiptTimeLimit");

                    b.Property<Guid>("UniqueId");

                    b.HasKey("Id");

                    b.HasIndex("InteracationId");
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.ReadOnly.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("IssuingAccountId");
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.UserPaymentMethod", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Payment.ManagedXlmPayment", b =>
                {
                    b.HasBaseType("Stellmart.Api.Context.Entities.PaymentMethod");


                    b.ToTable("ManagedXlmPayment");

                    b.HasDiscriminator().HasValue("ManagedXlmPayment");
                });

            modelBuilder.Entity("Stellmart.Api.Context.Entities.Payment.UnmanagedXlmPayment", b =>
                {
                    b.HasBaseType("Stellmart.Api.Context.Entities.PaymentMethod");


                    b.ToTable("UnmanagedXlmPayment");

                    b.HasDiscriminator().HasValue("UnmanagedXlmPayment");
                });
            ...
            modelBuilder.Entity("Stellmart.Api.Context.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("Stellmart.Api.Context.Entities.ReadOnly.RewardsLevel")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Contract", b =>
                {
                    b.HasOne("Stellmart.Api.Context.Entities.ReadOnly.Asset", "FundingAsset")
                        .WithMany("Contracts")
                        .HasForeignKey("FundingAssetId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Stellmart.Api.Context.Entities.Obligation", "Obligation")
                        .WithMany("Contracts")
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.LineItem", b =>
                {
                    b.HasOne("Stellmart.Api.Context.Entities.Cart", "Cart")
                        .WithMany("LineItems")
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Listing", b =>
                {
                    b.HasOne("Stellmart.Api.Context.Entities.ReadOnly.Currency", "Currency")
                        .WithMany("Listings")
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Obligation", b =>
                {
                    b.HasOne("Stellmart.Api.Context.Interaction", "Interaction")
                        .WithMany("Obligations")
                        .HasForeignKey("InteracationId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Stellmart.Api.Context.ApplicationUser", "Purchaser")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.OrderItem", b =>
                {
                    b.HasOne("Stellmart.Api.Context.Entities.Contract", "Contract")
                        .WithOne("OrderItem")
                        .HasForeignKey("Stellmart.Api.Context.Entities.OrderItem", "ContractId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Stellmart.Api.Context.Entities.ProductShipment", "Shipment")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Stellmart.Api.Context.Entities.UserPaymentMethod", b =>
                {
                    b.HasOne("Stellmart.Api.Context.Entities.PaymentMethod", "PaymentMethod")
